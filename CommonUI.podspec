...
Pod::Spec.new do |spec|
  ...
  spec.name         = "CommonUI"
  spec.version      = "1.0.0"
  spec.summary      = "CommonUI.framework for imovies-app"
  ...
  spec.homepage     = "https://github.com/egiwibowo13/imovie-common-ui"
  ...
  spec.source       = { :git => "https://github.com/egiwibowo13/imovie-common-ui.git", :tag => "#{spec.version}" }
  ...
  spec.resources = "CommonUI/**/*.{png,jpeg,jpg,xcassets}"
